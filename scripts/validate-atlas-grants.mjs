...
const checks = [
  ...
  ['federal grant applications submitted truthfully zero', store.includes('federalGrantApplicationsSubmitted: 0') && store.includes('submissionEvidence: []')],
  ...
  ['Project Pitch founder approval phrase stored', store.includes('I approve the NSF Project Pitch for submission.')],
