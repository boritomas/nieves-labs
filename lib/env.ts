export const env = {
  ...
  supportEmail: process.env.SUPPORT_EMAIL || process.env.ANSWERBRIEF_NOTIFY_EMAIL || process.env.GMAIL_FROM_EMAIL || 'hello@nieves-labs.com',
  adminToken: process.env.ADMIN_TOKEN || process.env.ADMIN_DASHBOARD_PASSWORD || '',
  stripeSecretKey: process.env.STRIPE_SECRET_KEY || '',
  stripeWebhookSecret: process.env.STRIPE_WEBHOOK_SECRET || '',
  answerBriefQuickPrepLink: process.env.NEXT_PUBLIC_STRIPE_QUICK_PREP_LINK || '',
  answerBriefFullBriefLink: process.env.NEXT_PUBLIC_STRIPE_FULL_INTERVIEW_BRIEF_LINK || '',
  answerBriefPremiumPrepLink: process.env.NEXT_PUBLIC_STRIPE_PREMIUM_PREP_LINK || '',
  ...
  googleSheetsOrdersSheetName: process.env.GOOGLE_SHEETS_ORDERS_SHEET_NAME || 'orders',
  googleSheetsIntakeSheetName: process.env.GOOGLE_SHEETS_INTAKE_SHEET_NAME || 'intake',
