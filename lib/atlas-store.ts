...
const seedGrantOperator: AtlasGrantOperator = {
  ...
  submissionEvidence: [
    {
      id: 'nsf-project-pitch-00119518',
      agency: 'U.S. National Science Foundation',
      program: 'NSF SBIR/STTR / America’s Seed Fund',
      opportunityNumber: 'NSF Project Pitch gate',
      submissionType: 'Project Pitch',
      projectTitle: 'Evidence-Provenance AI for Small-Business Funding Workflows',
      submittedAt: '2026-07-14T13:09:00-05:00',
      submittedBy: 'Tomas Nieves account, populated through Atlas operator with founder approval',
      portal: 'NSF TIP Submission Portal / MyWork',
      workspaceId: '00119518',
      confirmationNumber: '00119518',
      confirmationUrl: 'https://nsfgov.my.site.com/mywork/s/my-pitch-submissions',
      receiptFile: 'outputs/nsf-project-pitch/nsf-submission-confirmation.txt',
      submittedPackageVersion: 'grant-package-nsf-project-pitch-ai',
      submittedDocuments: ['NSF Project Pitch form fields only; no file attachments submitted.'],
  ...
  officialSourcesSearched: [
    ...
    'Post-submission live Grants.gov review of NSF 26-511, NIH PA-27-100, and NSF 26-506',
  ],
  ...
  opportunities: [
    ...
    },
    {
      ...
      concerns: ['Health-domain fit not proven', 'eRA Commons registration likely required', 'Scientific aims would need domain partner or validated health use case', 'Live Grants.gov record confirms Health category and NIH/CDC/FDA assistance listings.'],
      missingEvidence: ['Health-market technical problem', 'Qualified PI/domain partner', 'Institute-specific topic fit'],
      recommendedAction: 'Do not submit under the current Nieves Labs evidence package. Monitor only unless Tomas approves a truthful health, CDC, FDA, biomedical, or public-health R&D concept with appropriate expertise.',
      pursueRecommendation: 'Monitor',
      narsClassification: 'Verified fact',
    },
    {
      ...
      concerns: ['Ecosystem evidence missing', 'Partner/governance commitments likely needed', 'Not a near-term operating-capital grant', 'Live Grants.gov record confirms the opportunity is for safe and sustainable open-source ecosystems.'],
      missingEvidence: ['Open-source project', 'Community governance plan', 'Partner commitments'],
      recommendedAction: 'Do not submit under the current Nieves Labs evidence package. Monitor as a future Atlas reliability/open-source strategy opportunity after an approved open-source product, governance plan, and partner/community evidence exist.',
      pursueRecommendation: 'Monitor',
      narsClassification: 'Verified fact',
    },
  ],
  selectedPackage: {
    ...
    founderOnlyGaps: ['Monitor info@nieves-labs.com for NSF feedback within approximately one month', 'Do not submit another NSF Project Pitch while this pitch is pending', 'If invited, verify NSF ID/Research.gov organization, SAM.gov, UEI, Grants.gov, PI/SPO/AOR roles, and full proposal requirements', 'If not invited, revise the pitch in the next submission window based on NSF feedback'],
    readinessScore: 92,
    applicationPortal: 'Official NSF Project Pitch / MyWork Community portal',
    furthestSafePoint: 'NSF Project Pitch submitted. Next gate is NSF review feedback or invitation before any full Phase I proposal.',
    submissionStatus: 'Submitted to NSF Project Pitch portal. Confirmation number 00119518. Await NSF feedback by email within approximately one month.',
    confirmationNumber: '00119518',
    followUpDate: '2026-08-14',
    learningRecords: ['Official NSF sources confirm Project Pitch is required before any invited full Phase I proposal.', 'NSF 26-511 is monitored rather than treated as the selected submission path.', 'The strongest current concept is evidence-provenance AI for regulated small-business funding workflows.', 'NSF portal accepted Project Pitch submission 00119518 under Artificial Intelligence (AI).'],
    updatedAt: now,
  },
  nsfProjectPitch: {
    ...
    missingEvidence: [
      'NSF review outcome or invitation to submit a full Phase I proposal.',
      'Verified NSF ID / Research.gov organization record for invited full proposal stage.',
      'SAM.gov, UEI, Grants.gov, PI/SPO/AOR role status for invited full proposal stage.',
      'Any customer/pilot/revenue metrics Tomas wants to cite in a future full proposal.',
    ],
  ...
  activityFeed: [
    { id: 'truthful-submission-status', timestamp: now, status: 'Completed', label: 'Recorded federal submission evidence', detail: 'Federal grant applications submitted: 1. NSF Project Pitch confirmation number 00119518 captured.' },
    ...
    { id: 'prepared-project-pitch', timestamp: now, status: 'Completed', label: 'Generated Project Pitch', detail: 'Prepared exact Project Pitch responses, assumptions, missing evidence, and founder approval phrase.' },
    { id: 'submitted-nsf-project-pitch', timestamp: now, status: 'Completed', label: 'Submitted NSF Project Pitch', detail: 'NSF portal accepted Project Pitch 00119518 for the Artificial Intelligence topic area. Await email feedback within approximately one month.' },
