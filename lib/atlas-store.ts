  ...
  fundingOpportunities: [
    {
      ...
      nextFollowUpDate: 'Next 3 business days',
      lastContactedDate: '',
      statusNotes: 'Primary active lender. PeopleFund states it is a Texas nonprofit CDFI and certified SBA microlender with startup-friendly language and no fee to apply.',
      notes: 'Best current fit for a $50,000 SBA/CDFI-style small-business request, subject to lender underwriting.',
      nextAction: 'Open official PeopleFund application, map confirmed fields, and stop for founder-only identity/credit/certification actions.',
      createdAt: now,
      updatedAt: now,
    },
    {
      ...
      nextFollowUpDate: 'Next 5 business days',
      lastContactedDate: '',
      statusNotes: 'Secondary lender. BCL publishes a small-business path up to $50,000 and a new-business lending path for owners within two years of opening.',
      notes: 'Strong fallback if PeopleFund cannot proceed or requires conditions that are not currently feasible.',
      nextAction: 'Submit inquiry or schedule consultation after founder confirms eligibility and personal financial readiness.',
      createdAt: now,
      updatedAt: now,
    },
    {
      ...
      nextFollowUpDate: 'After PeopleFund path is assessed',
      lastContactedDate: '',
      statusNotes: 'Paused - lender website/founder-only field blocker preserved for tracking.',
      notes: 'Do not delete. Preserve completed non-sensitive fields and URL.',
      nextAction: 'Resume only after founder confirms EIN/entity/start-date fields and any portal blockers are resolved.',
      createdAt: now,
      updatedAt: now,
    },
  ],
