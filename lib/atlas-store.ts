...
const seedGrantOperator: AtlasGrantOperator = {
  ...
  nsfProjectPitch: {
    ...
    fields: [
      { id: 'technology-innovation', label: 'Technology Innovation', purpose: 'Explain the core innovation and why it is more than ordinary software development.', evidenceStatus: 'AI-generated draft', founderReviewRequired: true, response: 'Nieves Labs is developing an evidence-provenance AI layer for small businesses navigating regulated funding workflows. The innovation is an auditable reasoning system that can ingest founder documents, official requirements, portal questions, and workflow history, then label each output as verified evidence, planning assumption, generated draft, contradiction, missing proof, or founder-only certification. Unlike static grant databases or generic writing tools, the system is designed to preserve the source and legal status of each claim while reducing duplicate founder questions and preventing unsupported application language.' },
      { id: 'technical-objectives', label: 'Technical Objectives and Challenges', purpose: 'State the R&D questions and uncertainty.', evidenceStatus: 'AI-generated draft', founderReviewRequired: true, response: 'The project will test whether retrieval, classification, contradiction detection, prompt/version traceability, and human approval gates can produce funding packages that are both useful and auditable. Key technical challenges include separating verified business facts from inferred assumptions, reconciling conflicting documents, mapping official requirements to available evidence, detecting missing proof before submission, and creating reliable founder-only gates for legal certifications. The core research question is whether an AI operator can improve completeness and traceability in high-stakes small-business applications without fabricating claims or shifting legal decisions away from the founder.' },
      { id: 'market-opportunity', label: 'Market Opportunity', purpose: 'Identify customers and commercial need.', evidenceStatus: 'Planning assumption', founderReviewRequired: true, response: 'The initial market includes founders, small businesses, CDFIs, accelerators, advisors, and service providers that help companies prepare SBA loans, CDFI applications, grants, and other funding packages. These workflows are document-heavy, repetitive, and error-prone. Customers need a system that can reuse known company information, track evidence gaps, prepare package-specific drafts, and clearly identify when founder review or legal certification is required. Atlas will begin as an internal Nieves Labs operating system and can expand into a subscription product or managed-service platform for small-business funding preparation.' },
      { id: 'company-team', label: 'Company and Team', purpose: 'Describe Nieves Labs without inventing credentials.', evidenceStatus: 'Founder provided', founderReviewRequired: true, response: 'Nieves Labs is a Texas-based AI products company founded by Tomas Nieves. The company is building practical AI tools and automation workflows, including the Nieves AI Platform and Atlas Capital Office. Atlas has already been used internally to organize funding readiness, lender tracking, application packages, document checklists, founder approval gates, and workflow lessons learned. No patents, institutional partners, customer revenue, or third-party validation are claimed in this Project Pitch unless Tomas later provides evidence.' },
      { id: 'proposed-rd', label: 'Proposed R&D', purpose: 'Summarize Phase I work.', evidenceStatus: 'AI-generated draft', founderReviewRequired: true, response: 'Phase I R&D would define the evidence taxonomy, build the provenance-aware data model, implement retrieval and classification modules, create contradiction and missing-evidence detection, map official requirements to company evidence, add prompt/version logging, and validate founder approval gates. Evaluation would measure duplicate-question reduction, evidence-label accuracy, missing-document detection, unsupported-claim prevention, and founder time saved across SBA/CDFI and NSF-style package workflows.' },
      { id: 'commercial-potential', label: 'Commercial Potential', purpose: 'Explain business model and adoption path.', evidenceStatus: 'Planning assumption', founderReviewRequired: true, response: 'Commercialization would start with Nieves Labs using Atlas internally, then expand to founders and advisors who need faster funding-package preparation with less manual tracking. Potential revenue models include subscription access, package-based services, advisor/team seats, and partner workflows for accelerators or small-business support organizations. The long-term product is an applicant-side funding operating system that combines document intelligence, compliance-aware drafting, workflow tracking, and human approval controls.' },
      { id: 'federal-funding-need', label: 'Why Federal R&D Funding Is Needed', purpose: 'Explain why grant funding is appropriate.', evidenceStatus: 'Planning assumption', founderReviewRequired: true, response: 'The technical work requires systematic R&D and evaluation before it can be responsibly commercialized for regulated funding workflows. Federal R&D support would allow Nieves Labs to test reliability, provenance, contradiction detection, and approval-gate methods beyond ordinary product development, while reducing pressure to ship unsupported automation into high-stakes customer workflows prematurely.' },
      { id: 'risks-outcomes', label: 'Technical Risks and Expected Outcomes', purpose: 'Identify risks and measurable outputs.', evidenceStatus: 'AI-generated draft', founderReviewRequired: true, response: 'Key risks include incorrect evidence classification, missed contradictions, unsupported generated claims, weak official-requirement mapping, and over-reliance on AI output. Expected outcomes include a working prototype, evidence-labeling benchmarks, contradiction/missing-proof tests, prompt registry and version logs, founder-only approval gates, QA validation, and a measured pilot showing whether the system improves funding-package readiness while preserving founder control over legal assertions.' },
    ],
    assumptions: [
