  ...
  return (
    <section className="mx-auto max-w-6xl space-y-5 px-4 pb-16">
      <div className={panelClass}>
        ...
        <p className="mt-2 text-sm text-slate-300">Source-based case facts: Eastern District of Texas, case 25-42914, discharge entered January 7, 2026; Equifax filing-date discrepancy; missing discharge or closing date; and reported Bank of America post-discharge balance and past-due amounts.</p>
      </div>
      ...
      {active === 'strategy' ? (
        <div className="grid gap-5 lg:grid-cols-2">
          <div className={panelClass}>
            ...
            <ol className="mt-4 space-y-2 text-sm text-slate-300">
              <li>1. Dispute the Equifax September 1, 2025 filing date against the September 30, 2025 date reported by TransUnion and Experian.</li>
              <li>2. Dispute the missing January 7, 2026 discharge or closing date.</li>
              <li>3. Dispute Bank of America’s reported $10,849 balance and $10,849 past due after discharge, if the account was included.</li>
              <li>4. Audit every included account for nonzero balances, post-petition delinquencies, charge-off coding, and re-aging.</li>
            </ol>
          </div>
          <div className={panelClass}>
            ...
            <ol className="mt-4 space-y-2 text-sm text-slate-300">
              ...
              <li>3. Compare the response with the court record and bureau discrepancies.</li>
              <li>4. Escalate unresolved inaccuracies to the CFPB with the discharge order and highlighted report pages.</li>
        ...
        <div className={panelClass}>
          <textarea className={`${fieldClass} font-mono`} rows={20} readOnly value={drafts[active]} />
